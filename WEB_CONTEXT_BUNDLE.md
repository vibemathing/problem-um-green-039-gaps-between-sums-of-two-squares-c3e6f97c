...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-039-gaps-between-sums-of-two-squares-c3e6f97c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-039"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-039-gaps-between-sums-of-two-squares-c3e6f97c-v1",
      "problem_contract_sha256": "c8e6390841e796a0f67d06a3fc54383f6f1dcd10530b62b71a755455e5451f2e",
      "problem_id": "problem:um-green-039-gaps-between-sums-of-two-squares-c3e6f97c",
      "route_id": "route:um-green-039-gaps-between-sums-of-two-squares-c3e6f97c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-039-gaps-between-sums-of-two-squares-c3e6f97c-source-fidelity-01",
      "graph_id": "graph:um-green-039-gaps-between-sums-of-two-squares-c3e6f97c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-039-gaps-between-sums-of-two-squares-c3e6f97c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-039-gaps-between-sums-of-two-squares-c3e6f97c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is there always a sum of two squares between $X - \\frac{1}{10}X^{1/4}$ and $X$?"
          },
          "statement_sha256": "e54ee12c75f8b121aaeda828faa9b3abed57b6598e97ece86aff6bd80db8a276"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-039-gaps-between-sums-of-two-squares-c3e6f97c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-039-gaps-between-sums-of-two-squares-c3e6f97c-root",
      "route_id": "route:um-green-039-gaps-between-sums-of-two-squares-c3e6f97c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-039-382e9240ff72",
        "url": "https://www.unsolvedmath.com/problems/GREEN-039"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
